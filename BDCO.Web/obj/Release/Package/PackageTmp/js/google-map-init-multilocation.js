function initialize() {
    ...
    // Multiple Markers
    var markers = [
        //['Save the Children (Bangladesh)', 23.791516, 90.411532],
        ['Barguna', 22.165379,	90.12335],
        ['Barisal', 22.700277,	90.372776],
        ["Cox's Bazar", 21.442965,	91.973853],
        ['Dhaka', 23.711394,	90.41136],
        ['Habiganj', 24.375039,	91.415417],
        ['Jessore', 23.166684,	89.207524],
        ['Jhalokati', 22.642202,	90.199975],
        ['Jhenaidah', 23.546093,	89.154131],
        ['Khagrachhari', 23.112535,	91.988952],
        ['Kurigram', 25.809149,	89.635647],
        ['Magura', 23.487898,	89.420331],
        ['Manikganj', 23.860128,	90.000874],
        ['Naogaon', 24.832545,	88.924901],
        ['Nilphamari', 25.931851,	88.855841],
        ['Patuakhali', 22.359959,	90.329839],
        ['Rangpur', 25.755813,	89.24448],
        ['Sunamganj', 25.066023,	91.395384],
        ['Sylhet', 24.891929,91.868935],
        ['Tangail', 24.266628, 89.918321]
    ];
                        
    // Info Window Content
    var infoWindowContent = [
        //['<div class="info_content">' +
        //'<h3>Save the Children (Bangladesh)</h3>' +
        //'<p>House CWN (A) 35, Road 43 1212, Dhaka 1212,Bangladesh</p>' + '</div>'],
        ['<div class="info_content"><h3>Barguna</h3>'],
        ['<div class="info_content"><h3>Barisal</h3>'],
        ['<div class="info_content"><h3>Coxs Bazar</h3>'],
        ['<div class="info_content"><h3>Dhaka</h3>'],
        ['<div class="info_content"><h3>Habiganj</h3>'],
        ['<div class="info_content"><h3>Jessore</h3>'],
        ['<div class="info_content"><h3>Jhalokati</h3>'],
        ['<div class="info_content"><h3>Jhenaidah</h3>'],
        ['<div class="info_content"><h3>Khagrachhari</h3>'],
        ['<div class="info_content"><h3>Kurigram</h3>'],
        ['<div class="info_content"><h3>Magura</h3>'],
        ['<div class="info_content"><h3>Manikganj</h3>'],
        ['<div class="info_content"><h3>Naogaon</h3>'],
        ['<div class="info_content"><h3>Nilphamari</h3>'],
        ['<div class="info_content"><h3>Patuakhali</h3>'],
        ['<div class="info_content"><h3>Rangpur</h3>'],
        ['<div class="info_content"><h3>Sunamganj</h3>'],
        ['<div class="info_content"><h3>Sylhet</h3>'],
        ['<div class="info_content"><h3>Tangail</h3>']
